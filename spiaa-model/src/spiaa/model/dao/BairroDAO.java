...
public class BairroDAO implements BaseDAO<Bairro> {
  ...
  public static final String CRITERION_QUARTEIRAO = "2";
  ...
  public List<Bairro> readByCriteria(Map<String, Object> criteria, Connection conn) throws Exception {
    ...
    String sql = "SELECT b.*,q.id as q_id, q.descricao, q.bairro_fk FROM bairro b LEFT JOIN quarteirao q ON b.id=q.bairro_fk WHERE 1=1  ";
    ...
    String criterionQuarteirao = (String) criteria.get(CRITERION_QUARTEIRAO);
    if (criterionQuarteirao != null && (!criterionQuarteirao.isEmpty())) {
      sql += " AND q.bairro_fk = " + criterionQuarteirao;
    }

...
<br/><br/><br/>
                                    ...
                                    <form role="form" id="formConsolidacao" method="POST">
                                ...
                                <div class="form-inline col-md-12">
                                    ...
                                    <div class="form-group col-md-2 ">
                                        ...
                                        <input type="text" class="form-control validate[required,custom[number]]" id="programados" name="programados" value="${consolidacaoDados.programados}">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="inspecionados">Inspecionados : </label>
                                        <input type="text" class="form-control validate[required,custom[number]]" id="inspecionados" name="inspecionados" value="${consolidacaoDados.inspecionados}">
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="terrenobaldio">Terreno Baldio : </label>
                                        <input type="text" class="form-control validate[required,custom[number]]" id="terrenobaldio" name="terrenobaldio" value="${consolidacaoDados.terrenobaldio}">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="outros">Outros :</label>
                                        <input type="text" class="form-control validate[required,custom[number]]" id="outros" name="outros" value="${consolidacaoDados.outros}">
                                    </div>
                                ...
                                <div class="form-inline col-md-12">
                                    ...
                                    <c:if test="${empty consolidacaoDados.consolidacaoCriadouroList}">
                                        <c:forEach var="criadouro" items="${criadouroList}">
                                            ...
                                            <div class="form-group col-md-1">
                                                ...
                                                <input type="text" class="form-control validate[custom[number]]"  name="qdte">
                                    ...
                                    <c:if test="${not empty consolidacaoDados.consolidacaoCriadouroList}">
                                        ...
                                        <c:forEach var="concriadouro" items="${consolidacaoDados.consolidacaoCriadouroList}">
                                            ...
                                            <div class="form-group col-md-1">
                                                <label for="criadouro">${concriadouro.criadouro.grupo} :</label>
                                                <input type="text" class="form-control"  name="qdte" value="${concriadouro.quantidade}">
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                jQuery("#formConsolidacao").validationEngine('attach', {promptPosition: "bottomLeft", autoPositionUpdate: true});
            });
        </script>
        <!-- /#wrapper -->
    </body>
